...
class exercise8 extends StatefulWidget {
  ...
  const exercise8({Key? key, required this.onExerciseComplete}) : super(key: key);

  @override
  _exercise1State createState() => _exercise1State();
}

class _exercise1State extends State<exercise8> {
  BannerAd? _bannerAd;
                  ...
                  Center(
                    child: Container(
                      ...
                      child: Stack(
                        fit: StackFit.expand,
                        children: [
                          Image.asset('assets/image/exercie8.gif'),
                        ],
                      ),
                    ),
                  ),
