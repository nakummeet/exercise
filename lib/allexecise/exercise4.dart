...
class exercise4 extends StatefulWidget {
  ...
  const exercise4({Key? key, required this.onExerciseComplete}) : super(key: key);

  @override
  _exercise1State createState() => _exercise1State();
}

class _exercise1State extends State<exercise4> {
  BannerAd? _bannerAd;
                  ...
                  Center(
                    child: Container(
                      ...
                      child: Stack(
                        fit: StackFit.expand,
                        children: [
                          Image.asset('assets/image/exercise4.gif'),
                        ],
                      ),
                    ),
                  ),
